...
public class CircleView extends ImageView {
    ...
    public void setScaleType(ScaleType scaleType) {
        if (SCALE_TYPE != scaleType) {
            ...
            throw new IllegalArgumentException(String.format("ScaleType %s not support", scaleType));
        }
    }
    ...
    public void setBorderColorResource(int color) {
        setBorderColor(getContext().getResources().getColor(color));
